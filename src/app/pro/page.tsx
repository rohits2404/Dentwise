                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Get Unlimited AI Consultations, Advanced
                                    Features, And Priority Support To Take Your
                                    Dental Health To The Next Level.
                                </p>
                            </div>
                        </div>
                ...
                <div className="space-y-8">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Select The Perfect Plan For Your Dental Care Needs.
                            All Plans Include Secure Access And Bank-Level
                            Encryption.
                        </p>
                    </div>
