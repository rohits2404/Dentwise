...
import { BookingConfirmationStep } from "@/components/appointments/booking-confirmation-step";
import { DoctorSelectionStep } from "@/components/appointments/doctor-selection-step";
import { ProgressSteps } from "@/components/appointments/progress-steps";
import { TimeSelectionStep } from "@/components/appointments/time-selection-step";
        ...
        bookAppointmentMutation.mutate(
            ...
            },
            {
                onSuccess: async (appointment) => {
                    // Store appointment details for the confirmation modal
                    ...
                    try {
                        await sendAppointmentConfirmationEmail({
                            ...
                            appointmentType:
                                appointmentType?.name || "Dental Consultation",
                            duration: appointmentType?.duration || "30 minutes",
                            price: appointmentType?.price || "N/A",
                        });
