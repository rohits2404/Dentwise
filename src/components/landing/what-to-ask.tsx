            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="text-center mb-20">
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        From Simple Questions To Complex Concerns, Our AI
                        Delivers Expert-Level Guidance Trained On Thousands Of
                        Real Dental Cases.
                    </p>
                </div>
                                        ...
                                        <div className="space-y-3 flex-1">
                                            ...
                                            <div className="bg-muted/30 rounded-2xl p-4">
                                                <p className="text-sm text-muted-foreground leading-relaxed">
                                                    Get Immediate Advice On Pain
                                                    Management, Possible Causes,
                                                    And When To See A Dentist
                                                    Urgently.
                                                </p>
                                        ...
                                        <div className="space-y-3 flex-1">
                                            ...
                                            <div className="bg-muted/30 rounded-2xl p-4">
                                                <p className="text-sm text-muted-foreground leading-relaxed">
                                                    ...
                                                    Pricing Ranges, And Find The
                                                    Best Whitening Solution For
                                                    Your Budget.
                                                </p>
                                                <div className="flex gap-2 mt-3">
                                                    <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">
