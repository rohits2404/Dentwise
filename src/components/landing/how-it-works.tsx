                ...
                <div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
                    ...
                    <div className="relative group">
                        <div className="relative bg-linear-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                            ...
                            <p className="text-muted-foreground text-center leading-relaxed mb-6">
                                Chat With Our AI Assistant About Any Dental
                                Concerns. Get Instant Answers About Symptoms,
                                Treatments, And Oral Health Tips.
                            </p>
                    ...
                    <div className="relative group">
                        <div className="relative bg-linear-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                            ...
                            <p className="text-muted-foreground text-center leading-relaxed mb-6">
                                ...
                                Thousands Of Dental Cases. Our AI Provides
                    ...
                    <div className="relative group">
                        <div className="relative bg-linear-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                            ...
                            <p className="text-muted-foreground text-center leading-relaxed mb-6">
                                Schedule With Verified Dentists And Receive
                                Comprehensive Follow-Up Care. Track Your
                                Progress Seamlessly.
                            </p>
