                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        Upgrade To AI Pro Or AI Basic To Unlock
                                        Unlimited Voice Consultations With Our
                                        AI Dental Assistant.
                                    </p>
                                </div>
                            </div>
                ...
                <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30 max-w-2xl mx-auto">
                    <CardContent className="relative p-8 text-center">
                        ...
                        <p className="text-muted-foreground mb-6">
                            The Voice Assistant Feature Is Available To AI Pro
                            And AI Basic Subscribers. Get Instant Dental Advice
